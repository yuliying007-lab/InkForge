...
```html
<section style="display:flex;align-items:center;gap:8px;margin:24px 0;">
...
```html
<section style="margin:24px 0;height:1px;background:linear-gradient(to right, transparent, {{PRIMARY}}, transparent);opacity:0.15;"></section>
```
...
```html
<section style="display:flex;align-items:center;gap:10px;margin:28px 0 16px;">
...
```html
<section style="margin:28px 0;display:flex;gap:4px;">
...
```html
<section style="text-align:center;margin:24px 0;overflow:hidden;">
