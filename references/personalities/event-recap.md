...
<section style="flex:1;background-color:{{HIGHLIGHT_BG}};background:linear-gradient(135deg, {{HIGHLIGHT_BG}} 0%, {{BG}} 100%);border:1px solid {{HIGHLIGHT_BG}};padding:36px 10px;text-align:center;">
<p style="font-size:11px;color:{{TEXT_LIGHT}};margin:0;">[ Claude 生成装饰插画位置 ]</p>
</section>
<section style="flex:1;background-color:{{HIGHLIGHT_BG}};background:linear-gradient(135deg, {{HIGHLIGHT_BG}} 0%, {{BG}} 100%);border:1px solid {{HIGHLIGHT_BG}};padding:36px 10px;text-align:center;">
<p style="font-size:11px;color:{{TEXT_LIGHT}};margin:0;">[ Claude 生成装饰插画位置 ]</p>
</section>
